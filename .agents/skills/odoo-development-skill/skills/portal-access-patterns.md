        ...
        <t t-if="documents">
            <t t-call="portal.portal_table">
                ...
                >
                            ...
                            <td>
                                <span
                  t-field="document.create_date"
                  t-options="{'widget': 'date'}"
                />
                            </td>
                            <td>
                                <span
                  t-attf-class="badge #{document.state == 'done' and 'bg-success' or 'bg-secondary'}"
                >
        ...
        <t t-call="portal.portal_record_layout">
            <t t-set="card_header">
                <h3 class="mb-0">
                    ...
                    <span
            t-attf-class="badge #{document.state == 'done' and 'bg-success' or 'bg-info'}"
          >

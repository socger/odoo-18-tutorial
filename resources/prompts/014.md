...
- Extender modelo: fleet.vehicle ... modelo a crear en módulo socger_expand_fleet
  ...
  - Crear/extender vistas:
    ...
    - Vista form:
      - Debajo del field "license_plate" y antes del field "tag_ids", poner el field
        "vehicle_code".

    Estos cambios que se solicitan a continuación no se han conseguido todavía. Intentar
    solucionarlos y explicar porqué no funcionaron:

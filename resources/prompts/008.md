...
- Modificar modelo: fleet.vehicle ... modelo de Odoo, pero que ha sido modificado en el
  módulo socger_expand_fleet socger_expand_fleet
  - Modificar vistas:
    - Vista form: En la pestaña con título en español "Conceptos de control de costes,
      presupuestos ó ventas" se presentan las líneas ligadas al vehículo en el que
      estamos con el modelo "concept.cost.budget.sale.by.vehicle". Pues queremos que
      también aparezca el field "value"

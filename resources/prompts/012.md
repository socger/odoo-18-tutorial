...
- Extender modelo: fleet.vehicle ... modelo a crear en módulo socger_expand_fleet
  ...
  - Añadir fields:
    ...
    - field: fleet_garage_id, type: Many2one con tabla "fleet_garage", required: True,
      tracking: True, en cualquier vista aparecerá con el título "Cochera". Este campo
      cuando se presente en alguna vista debe de poner el valor del campo "name" de la
      tabla/modelo "fleet.garage"

  - Crear/extender vistas:
    - Vista form: Sustituir el field "location" por el field "fleet_garage_id".
